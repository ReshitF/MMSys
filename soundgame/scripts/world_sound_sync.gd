...
@onready var audio_player_3d = $"sound_node/step 1"  # Reference to the 3D audio player
@onready var listener_3d = $"sound_node/microphone"  # Reference to the 3D listener (optional)
